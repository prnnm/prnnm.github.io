    ...
    function save() {
        ...
        var td1 = document.getElementById("td1.1").innerHTML = a5;
        var td2 = document.getElementById("td1.2").innerHTML = no;
        var td3 = document.getElementById("td1.3").innerHTML = no1;
    }
